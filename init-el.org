...
#+begin_src emacs-lisp
  ...
  (add-hook 'after-init-hook '(lambda () (sergio/open-init) (switch-to-prev-buffer)))
#+end_src
...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    :init
    (when (and (file-directory-p "~/Documents") (file-directory-p "~/Documents/KTH/"))
      (setq projectile-project-search-path '("~/Documents" "~/Documents/KTH")))
