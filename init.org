...
(use-package embark
  ...
  (dolist (map (list corfu-map minibuffer-mode-map evil-normal-state-map evil-insert-state-map evil-visual-state-map))
...
(use-package json-mode
  :config
  (add-hook 'json-mode-hook #'(lambda () (setq-local tab-width 2)))
  :hook
  (json-mode . lsp)
  :custom
  (js-indent-level 2)
